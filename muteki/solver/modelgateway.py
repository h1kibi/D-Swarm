...
# env knobs
_GATEWAY_PORT = int(os.environ.get("MUTEKI_MODEL_GATEWAY_PORT", str(DEFAULT_GATEWAY_PORT)) or DEFAULT_GATEWAY_PORT)
_GATEWAY_BIND = os.environ.get("MUTEKI_MODEL_GATEWAY_BIND", "127.0.0.1").strip() or "127.0.0.1"
...
_UPSTREAM_BASE = os.environ.get(
    "MUTEKI_MODEL_GATEWAY_UPSTREAM", "https://api.deepseek.com").strip().rstrip("/")
