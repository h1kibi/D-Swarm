...
```bash
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh all
```

Run a narrower mode when you only want one tool group:

```bash
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh python
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh apt
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh brew
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh gems
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh go
bash /opt/dswarm/ctf-tools/install_ctf_tools.sh manual
```

The full package lists now live in [/opt/dswarm/ctf-tools/install_ctf_tools.sh](/opt/dswarm/ctf-tools/install_ctf_tools.sh).
