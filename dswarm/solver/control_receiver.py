...
class ControlReceiver:
    ...
    # DSWARM_CONTROL_LINK_DEADLINE=120 there.
    ...
    def __init__(self, host: Optional[str] = None, port: int = DEFAULT_CONTROL_PORT):
        # host=None → env-driven default (DSWARM_CONTROL_BIND, normally 127.0.0.1;
    ...
    def await_link(self, run_id: str, *, deadline_s: Optional[float] = None) -> _SupervisorLink:
        ...
        Default is DSWARM_CONTROL_LINK_DEADLINE (40s historical; raise to 120 on
